...
import * as DesktopPromptLinkHandler from "./app/DesktopPromptLinkHandler.ts";
...
const desktopPromptLinkHandlerLayer = DesktopPromptLinkHandler.layer.pipe(
  Layer.provide(desktopAppActivationLayer),
  Layer.provide(desktopWindowLayer),
);
